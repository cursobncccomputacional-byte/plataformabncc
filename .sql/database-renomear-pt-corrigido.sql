-- =====================================================
-- RENOMEAR TABELAS E CAMPOS PARA PORTUGUÊS (VERSÃO CORRIGIDA)
-- Banco: supernerds3
-- Esta versão descobre os nomes reais das foreign keys automaticamente
-- =====================================================
...
ALTER TABLE usuarios DROP INDEX IF EXISTS idx_role;
ALTER TABLE usuarios DROP INDEX IF EXISTS idx_active;
ALTER TABLE usuarios DROP INDEX IF EXISTS idx_created;
...
-- Atualizar índices
ALTER TABLE anos_escolares DROP INDEX IF EXISTS idx_level;
ALTER TABLE anos_escolares DROP INDEX IF EXISTS idx_order;
...
ALTER TABLE objetos_conhecimento DROP INDEX IF EXISTS idx_axis;
ALTER TABLE objetos_conhecimento
...
ALTER TABLE habilidades DROP INDEX IF EXISTS idx_code;
ALTER TABLE habilidades DROP INDEX IF EXISTS idx_knowledge_object;
...
-- Atualizar índices
ALTER TABLE atividades DROP INDEX IF EXISTS idx_type;
ALTER TABLE atividades DROP INDEX IF EXISTS idx_axis;
ALTER TABLE atividades DROP INDEX IF EXISTS idx_difficulty;
ALTER TABLE atividades DROP INDEX IF EXISTS idx_created;
...
ALTER TABLE cursos_video DROP INDEX IF EXISTS idx_created;
ALTER TABLE cursos_video DROP INDEX IF EXISTS idx_duration;
...
ALTER TABLE documentos DROP INDEX IF EXISTS idx_file_type;
ALTER TABLE documentos DROP INDEX IF EXISTS idx_created;
...
-- Atualizar índices
ALTER TABLE progresso_usuario DROP INDEX IF EXISTS idx_user;
ALTER TABLE progresso_usuario DROP INDEX IF EXISTS idx_video;
ALTER TABLE progresso_usuario DROP INDEX IF EXISTS idx_activity;
ALTER TABLE progresso_usuario DROP INDEX IF EXISTS idx_completed;
...
-- Atualizar índices
ALTER TABLE logs_atividade DROP INDEX IF EXISTS idx_user;
ALTER TABLE logs_atividade DROP INDEX IF EXISTS idx_activity;
ALTER TABLE logs_atividade DROP INDEX IF EXISTS idx_timestamp;
ALTER TABLE logs_atividade DROP INDEX IF EXISTS idx_session;
