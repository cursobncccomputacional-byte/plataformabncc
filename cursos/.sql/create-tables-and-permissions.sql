...
-- E SISTEMA DE PERMISSÕES POR CURSO
...
-- =====================================================
-- 1. ATUALIZAR ENUM DE ROLES (se necessário)
-- =====================================================
-- Nota: Se a tabela usuarios já existe, precisamos alterar o ENUM
-- ALTER TABLE usuarios MODIFY COLUMN nivel_acesso ENUM('root', 'admin', 'professor', 'aluno', 'professor_cursos') NOT NULL DEFAULT 'professor';
...
-- =====================================================
-- 4. TABELA DE PERMISSÕES CURSO-USUÁRIO
-- =====================================================
-- Esta tabela define quais usuários têm acesso a quais cursos
-- Usuários com perfil 'professor_cursos' só acessam cursos aqui listados
...
-- =====================================================
-- 6. TABELA DE PROGRESSO DAS AULAS
-- =====================================================
